...
من 10 لـ 100 بخطوة 10. الـ templates كلها **خارجية** جايه من
...
def main():
    print('=' * 70)
    # العنوان بيتولّد من FRAME_CONFIGS نفسه — كان مكتوب بالإيد وبار مرتين
    # لما القايمة اتغيّرت والعنوان فضل بيقول أرقام قديمة.
    print('  🎬 تجربة عدد الفريمات: '
          + ' · '.join(str(n) for n in FRAME_CONFIGS))
