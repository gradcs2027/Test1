...
الفرق الجوهري عن الـ DTW الساذج:
  الطريقة الساذجة بتاخد min(distances) على طول، يعني **مستحيل** تقول
  'other'. وده مشكلة قاتلة لأن الفيديوهات فيها فترات سكون كبيرة، فالـ
  baseline بيطلع برقم واطي **مش لأنه ضعيف، لأننا مانعناه يجاوب صح**.
